package utils.autoUnitTestUtil.autoTesting.PairwiseTesting;

import utils.autoUnitTestUtil.testResult.ConcolicParameterData;
import utils.autoUnitTestUtil.testResult.ConcolicTestData;
import utils.autoUnitTestUtil.testResult.ConcolicTestResult;
...
public class PairwiseTestingUtils {
    ...
    public static List<Parameter> convertTestResultToParameterValues(ConcolicTestResult testResult) {
        List<Parameter> result = new ArrayList<>();

        List<ConcolicTestData> testDataList = testResult.getFullTestData();
        for (ConcolicTestData testData : testDataList) {
            List<ConcolicParameterData> parameterDataList = testData.getParameterDataList();
    ...
    private static boolean findParameterAndAddValue(List<Parameter> parameters, ConcolicParameterData parameterData) {
